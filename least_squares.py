...
print("Mean squared error for Measles:","{:.4e}".format(error_measles))
print("Mean squared error for Mumps:","{:.4e}".format(error_mumps))
print("Mean squared error for Rubella:","{:.4e}".format(error_rubella))