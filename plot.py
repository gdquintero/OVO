...
# df_sero_outliers = pd.read_table("output/measles_outliers.txt",delimiter=" ",header=None,skiprows=2)
# df_only_outliers = pd.read_table("output/measles_only_outliers.txt",delimiter=" ",header=None,skiprows=0)
